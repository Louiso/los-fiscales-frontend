...
const convocatorias: Convocatoria[] = [{
  ...
  miembros: [],
  codigo: '774991',
  descripcionProceso: 'EJECUCIÓN DE IOARR: REMODELACION DE PLAZOLETA; EN EL(LA) CENTRO POBLADO DE OCOCOCHA  DISTRITO DE HUACACHI, PROVINCIA HUARI, DEPARTAMENTO ANCASH',
  ...
  item: {
    ...
    distrito: 'HUACACHI',
    provincia: 'HUARI',
    descripcion: 'EJECUCI¿N DE IOARR: REMODELACION DE PLAZOLETA; EN EL(LA) CENTRO POBLADO DE OCOCOCHA  DISTRITO DE HUACACHI, PROVINCIA HUARI, DEPARTAMENTO ANCASH',
    esPaquete: false,
    estado: 'CONSENTIDO',
